...
import com.pedrocactus.topobloc.app.ConstantsTestUIL;
import com.pedrocactus.topobloc.app.InfoPositionState;
        ...
        if (event.getDirection().equals("TOP")) {
            ...
            if (event.getStep() == InfoPositionState.DOWN.state) {
                if (!isCurrentFragment) {
                    ...
                    ((TopoblocApp) getActivity().getApplication()).setVoiesViewState(InfoPositionState.COTATION);
                ...
                if (!isCurrentFragment) {
                    ...
                    ((TopoblocApp) getActivity().getApplication()).setVoiesViewState(InfoPositionState.NOM);
                ...
                if (!isCurrentFragment) {
                    ...
                    ((TopoblocApp) getActivity().getApplication()).setVoiesViewState(InfoPositionState.DESCRITPTION);
                ...
                if (event.getStep() == InfoPositionState.DESCRITPTION.state) {
                    ...
                    if (!isCurrentFragment) {
                        ...
                        ((TopoblocApp) getActivity().getApplication()).setVoiesViewState(InfoPositionState.DOWN);
...
*/
    private void setupAnimations() {
        ...
        if(((TopoblocApp)getActivity().getApplication()).getVoiesViewState() == -1){

            ((TopoblocApp)getActivity().getApplication()).setVoiesViewState(InfoPositionState.DOWN);
            VIEWSTATE = InfoPositionState.DOWN.state;

        }else if(((TopoblocApp)getActivity().getApplication()).getVoiesViewState()!=-1){

            VIEWSTATE = ((TopoblocApp)getActivity().getApplication()).getVoiesViewState();
